...
#------------------------------------------------------------------------------------------------
   def setparams(self):
             ...
             if 'xtick.direction' not in  self.parameters.keys():        
                self.parameters['xtick.direction'] = 'out'
             if 'ytick.direction' not in  self.parameters.keys():        
                self.parameters['ytick.direction'] = 'out'
             ...
             myparams = {
               ...
               # 
               #     'xtick.color': 'k',
                     'xtick.direction': self.parameters['xtick.direction'],
               ...
               #      'ytick.color': 'k',
                     'ytick.direction': self.parameters['ytick.direction'],
       ...
       for i in range(nrows):
          for j in range(ncols):
             ...
             if nrows == ncols == 1:
                 ...
                 self.axs.tick_params(which='major', length=6.5)
